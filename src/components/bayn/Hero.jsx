...
const imageUrls = ["/ofplan/bayn_imgs/hero.png", "/ofplan/bayn_imgs/hero2.png", "/ofplan/bayn_imgs/hero3.png"];
      ...
      <div className="m-auto relative z-10 flex items-center justify-center h-full px-4 text-center">
        <div className="max-w-2xl w-full">
          <h2
            ...
            className="text-[20px] md:text-8xl mb-3 font-[400]"
          >
            Life at Bayn
          </h2>
          <div className="flex flex-col gap-5 mb-10">
            <p className="text-lg md:text-xl font-[700] mt-6 mb-2">
              A community where city energy meets coastal serenity—where every
              version of you belongs, without compromise.{" "}
            </p>
            <p>A community without compromise</p>
          </div>
