  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
      ...
      <div className="mt-12 md:mt-16 text-center">
        <button className="flex gap-2 m-auto items-center bg-[#16A2B8] hover:bg-cyan-600 text-white font-semibold px-4 py-2 rounded-full shadow-lg transition duration-300 transform hover:scale-105">
